...
const Account = Loadable(lazy( () => import('../views/dashboard/components/AccountComponents2')))
const Member = Loadable(lazy(() => import("../views/dashboard/components/MemberComponents2")))
